...
def main():
    ...
    print("  You need your MeshCore device key (64 or 128 hex characters).")
    print()
    print("  Where to find it:")
    print("  • meshcore_gui → Device Info")
    print("  • MeshCore companion app → device settings")
    print("  • MeshCore firmware configuration")
    print()
